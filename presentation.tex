...
\frametitle{Σκοπός}
    ...
    \begin{figure}[c]
        \includegraphics[width=0.5\linewidth, keepaspectratio]{fig/crouch-gait.png}
    \end{figure}
    
    \onslide<2>\let\thefootnote\relax\footnote{\hspace{-12pt}\eng{Arnolda A., "The role of estimating muscle-tendon lengths and velocities of the hamstrings in the evaluation and treatment of crouch gait", 2006}}
...
\begin{frame}
\frametitle{Βασικά πλεονεκτήματα του αλγορίθμου}
...
%    }
    ...
    \onslide<1>\let\thefootnote\relax\footnote{\hspace{-12pt}\eng{Shotton J., "Efficient Human Pose Estimation from Single Depth Images", 2011}}
\end{frame}
...
\frametitle{Αντιμετώπιση θορύβου στις μετρήσεις}
    ...
    \begin{center}
        \href{run:video/filter0.mpg}{\includegraphics[scale=0.15]{fig/play.jpeg}}
        \href{run:video/filter3.mpg}{\includegraphics[scale=0.15]{fig/play.jpeg}}
    \end{center}
...
\begin{frame}
\frametitle{Αποτελέσματα αντίστροφης κινηματικής}
    ...
    \begin{center}
        \begin{tabular}{cc}
            ...
            \includegraphics[width=.48\textwidth, height = 0.25\textheight, keepaspectratio]{fig/ik-reg5.png} & \includegraphics[width=.48\textwidth, height = 0.25\textheight, keepaspectratio]{fig/ik-reg6.png}
        \end{tabular}
    \end{center}
    }
    ...
    \begin{center}
        %\href{run:video/walk-motion-capture.mpg}{\includegraphics[scale=0.15]{fig/play.jpeg}}
        \href{run:video/walk-opensim.avi}{\includegraphics[scale=0.15]{fig/play.jpeg}}
    \end{center}
    }
...
\subsection{Κατηγορίες Μεθόδων Δυναμικής}
%\begin{frame}
%\frametitle{Κατηγορίες των μεθόδων δυναμικής ανάλυσης}
%
%\begin{block}{Κατηγορίες μεθόδων}
%    \begin{itemize}
%        \item<1-> Μέθοδοι αντίστροφης δυναμικής
%        \item<2-> Μέθοδοι ορθής δυναμικής
%        \begin{itemize}
%            \item<3-> Μεθόδων βασιζόμενοι στην ρύθμιση (\eng{PD} έλεγχος)
%            \item<4-> Μέθοδοι βασιζόμενοι σε κριτήρια βελτιστοποίησης
%        \end{itemize}
%    \end{itemize}
%\end{block}
%
...
\begin{frame}
\frametitle{Μέθοδος της ορθής δυναμικής}
...
\begin{frame}
\frametitle{Μυοσκελετική συσχέτιση}
    ...
    \begin{equation*}
        \begin{gathered}
            \ddot{q} = M(q)^{-1} \cdot \{ R(q) \cdot F^{M} - V(q, \dot{q}) - G(q) - F(q, \dot{q})\} \\[0.5cm]
...
\begin{frame}
\frametitle{Χαρακτηριστικά μυών}

    \only<1>{
    \begin{figure}[t]
        \includegraphics[width=1.0\linewidth, keepaspectratio]{fig/fiber-length-vs-knee-angle.png}
    \end{figure}
    }

    \only<2>{
    \begin{figure}[t]
        \includegraphics[width=1.0\linewidth, keepaspectratio]{fig/moment-arm-vs-knee-angle.png}
    \end{figure}
    }

    \only<3>{
    \begin{figure}[t]
        \includegraphics[width=1.0\linewidth, keepaspectratio]{fig/total-fiber-force.png}
    \end{figure}
    }
...
\begin{frame}
\frametitle{Μέθοδος υπολογισμού μυϊκών διεγέρσεων}
...
\begin{frame}
\frametitle{Αποτέλεσμα της ορθής δυναμικής}

    \only<1>{
    \begin{figure}[t]
        \includegraphics[width=1.0\linewidth, keepaspectratio]{fig/rf-vasint-activation.png}
    \end{figure}

    \begin{center}
        %\href{run:video/walk-motion-capture.avi}{\includegraphics[scale=0.15]{fig/play.jpeg}}
        \href{run:video/cmc.avi}{\includegraphics[scale=0.15]{fig/play.jpeg}}
    \end{center}
    }
...
\begin{center}
    \LARGE{Ευχαριστώ για την προσοχή σας!}\\[.5cm]
    \LARGE{Ερωτήσεις\;}
\end{center}
